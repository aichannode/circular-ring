			...
			useDailySleepScoreContributors(isoDay?: string): Record<SleepScoreContributors, Contributor> {
				...
				return {
					...
					[MetricType.UserDailyTranquility]: {
						...
						thresholdLow: data[MetricType.UserDailyTranquilityGoalMin] as number,
						thresholdHigh: data[MetricType.UserDailyTranquilityGoalMax] as number,
						percent: data[MetricType.UserDailyTranquility] as number,
						controlState: getScoreControlStates({
							lowThreshold: data[MetricType.UserDailyTranquilityGoalMin] as number,
							highThreshold: data[MetricType.UserDailyTranquilityGoalMax] as number,
					...
					[MetricType.UserDailyCircadianRhythm]: {
						...
						thresholdLow: data[MetricType.UserDailyCircadianRhythmGoalMin] as number,
						thresholdHigh: data[MetricType.UserDailyCircadianRhythmGoalMax] as number,
						percent: data[MetricType.UserDailyCircadianRhythm] as number,
						controlState: getScoreControlStates({
							lowThreshold: data[MetricType.UserDailyCircadianRhythmGoalMin] as number,
							highThreshold: data[MetricType.UserDailyCircadianRhythmGoalMax] as number,
					...
					[MetricType.UserDailyPercREMStageScore]: {
						...
						thresholdLow: data[MetricType.UserDailyPercREMStageScoreGoalMin] as number,
						thresholdHigh: data[MetricType.UserDailyPercREMStageScoreGoalMax] as number,
						percent: data[MetricType.UserDailyPercREMStageScore] as number,
						controlState: getScoreControlStates({
							lowThreshold: data[MetricType.UserDailyPercREMStageScoreGoalMin] as number,
							highThreshold: data[MetricType.UserDailyPercREMStageScoreGoalMax] as number,
					...
					[MetricType.UserDailyPercDeepStage]: {
						...
						thresholdLow: data[MetricType.UserDailyPercDeepStageScoreGoalMin] as number,
						thresholdHigh: data[MetricType.UserDailyPercDeepStageScoreGoalMax] as number,
						percent: data[MetricType.UserDailyPercDeepStage] as number,
						controlState: getScoreControlStates({
							lowThreshold: data[MetricType.UserDailyPercDeepStageScoreGoalMin] as number,
							highThreshold: data[MetricType.UserDailyPercDeepStageScoreGoalMax] as number,
					...
					[MetricType.UserDailyCoreTimeToFallAsleep]: {
						...
						thresholdLow: data[MetricType.UserDailyPercTimeToFallAsleepGoalMin] as number,
						thresholdHigh: data[MetricType.UserDailyPercTimeToFallAsleepGoalMax] as number,
						percent: data[MetricType.UserDailyPercTimeToFallAsleep] as number,
						controlState: getScoreControlStates({
							lowThreshold: data[MetricType.UserDailyPercTimeToFallAsleepGoalMin] as number,
							highThreshold: data[MetricType.UserDailyPercTimeToFallAsleepGoalMax] as number,
