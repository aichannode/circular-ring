...
export const CaloriesBurnedGraph: React.FC<Props> = observer(function CaloriesBurnedGraph({
	selectedDay,
	...
	const {
		measure: {
			hooks: { useLast7DaysCaloriesBurned },
		},
		calendar: {
			hooks: { useDailyTags },
		},
	...
	const data = useLast7DaysCaloriesBurned(selectedDay);
